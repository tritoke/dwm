...
static const char *brightness_up[]      = { "light", "sysfs/backlight/intel_backlight", "-A", "5", NULL };
static const char *brightness_down[]    = { "light", "sysfs/backlight/intel_backlight", "-U", "5", NULL };
