...
static const Key keys[] = {
	...
	{ MODKEY | ShiftMask,           XK_equal,                 spawn,          {.v = volume_up } },
	{ 0,                            XF86XK_AudioRaiseVolume,  spawn,          {.v = volume_up_big } },
	{ MODKEY,                       XK_equal,                 spawn,          {.v = volume_up_big } },
	{ 0,                            XF86XK_AudioLowerVolume,  spawn,          {.v = volume_down_big } },
	{ MODKEY,                       XK_minus,                 spawn,          {.v = volume_down_big } },
	{ ShiftMask,                    XF86XK_AudioLowerVolume,  spawn,          {.v = volume_down } },
	{ MODKEY | ShiftMask,           XK_minus,                 spawn,          {.v = volume_down } },
